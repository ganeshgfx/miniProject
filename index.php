		...
		<div>
			<nav class="navbar navbar-light bg-light">
				<div class="container-fluid">
					<a class="navbar-brand" href="#">Global Todo</a>

					<?php
					if (isset($_SESSION['user_id'])) {
						echo
						'<button data-bs-toggle="modal" data-bs-target="#todoModal" id="newToDo" type="button" class="btn btn-primary"><i class="bi bi-plus-circle-dotted"></i> New Todo</button>';
					} else {
						echo
						'';
					}
					...
					if (isset($_SESSION['user_id'])) {
						echo
						'<button type="button" class="btn"><i class="bi bi-person-circle"></i> ' . $_SESSION['user_id'] . '</button> ';
					} else {
						echo
